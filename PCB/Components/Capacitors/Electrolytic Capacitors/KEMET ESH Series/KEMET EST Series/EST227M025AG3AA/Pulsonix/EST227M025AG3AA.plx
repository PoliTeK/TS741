...
//1790091/1581014/2.50/2/2/Capacitor Polarised
...
(library Library_1
	...
	(patternDef "CAPPRD350W60D800H1250" (originalName "CAPPRD350W60D800H1250")
		(multiLayer
		...
		(layerContents (layerNumRef Courtyard_Top)
			(arc (pt 1.75, 0) (radius 4.5) (startAngle 0.0) (sweepAngle 0.0) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(arc (pt 1.75, 0) (radius 4.5) (startAngle 180.0) (sweepAngle 180.0) (width 0.05))
		)
		(layerContents (layerNumRef 18)
			(arc (pt 1.75, 0) (radius 4) (startAngle 0.0) (sweepAngle 0.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt 1.75, 0) (radius 4) (startAngle 180.0) (sweepAngle 180.0) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.75, 0) (radius 4) (startAngle 0.0) (sweepAngle 0.0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 1.75, 0) (radius 4) (startAngle 180.0) (sweepAngle 180.0) (width 0.025))
		)
	)
	(symbolDef "EST227M025AG3AA" (originalName "EST227M025AG3AA")
	...
	(compDef "EST227M025AG3AA" (originalName "EST227M025AG3AA") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "EST227M025AG3AA"))
		(attachedPattern (patternNum 1) (patternName "CAPPRD350W60D800H1250")
			(numPads 2)
			(padPinMap
		...
		(attr "Mouser Part Number" "80-EST227M025AG3AA")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/KEMET/EST227M025AG3AA?qs=gt1LBUVyoHnyrm3x6X1rbg%3D%3D")
		(attr "Manufacturer_Name" "KEMET")
		(attr "Manufacturer_Part_Number" "EST227M025AG3AA")
		(attr "Description" "EST, Aluminum, Aluminum Electrolytic, 220 uF, 20%, 25 VDC, -40/+105C, 105C, -40C, 105C, 7,000 Hrs, 14 % , 200 mOhms, 55 uA, 2, 3, 8mm, 11mm, Lead Spacing = 3.5mm, 20mm, 6000")
		(attr "<Hyperlink>" "https://content.kemet.com/datasheets/KEM_A4010_EST.pdf")
		(attr "<Component Height>" "12.5")
		(attr "<STEP Filename>" "EST227M025AG3AA.stp")
		(attr "<STEP Offsets>" "X=1.75;Y=0;Z=12.5")
